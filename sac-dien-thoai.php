      ...
      <div class="row">
         ...
         <div class="content">
            ...
            <div class="all">
                ...
                <li>
                    <p class="lileft">Dòng sạc tối đa:</p>
                ...
                <li>
                    ...
                    <span class="liright"><?= $fetch_product['details_11']; ?></span>
                </li>
...
<section class="view-post">
   ...
   ?> 
   <div class="heading-ct"><h1>chi tiết sản phẩm và đánh giá</h1> <a href="all_sạc_điện_thoại.php" class="inline-option-btn" style="margin-top: 0;">cửa hàng sạc điện thoại</a></div>
   <div class="row">
      <div class="col">
