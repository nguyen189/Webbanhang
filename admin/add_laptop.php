...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, key_word, brand, quantity_sp, details, import_price, price, discount, image_01, image_02, image_03, details_1, details_2, details_3, details_4, details_5, details_6, details_7, details_8, details_9, details_10) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_products->execute([$name, $key_word, $brand, $sl, $details, $import_price, $price, $discount, $image_01, $image_02, $image_03, $details_1, $details_2, $details_3, $details_4, $details_5, $details_6, $details_7, $details_8, $details_9, $details_10]);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box"  value ="laptop" name="key_word" readonly>
         </div>
         <div class="inputBox">
