...
if(!isset($admin_id)){
   // nếu biến tồn tại tiếp tục xử lý add_chuột
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box"  value ="chuot" name="key_word" readonly>
         </div>
         <div class="inputBox">
