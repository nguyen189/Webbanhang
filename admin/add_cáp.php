...
if(!isset($admin_id)){
   // nếu biến tồn tại thì bắt đầu add_cáp
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box"  value ="cap-dien-thoai" name="key_word" readonly>
         </div>
         <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Công suất tối đa<p>*</p></span>
