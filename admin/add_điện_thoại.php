   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box"  value ="dtdd" name="key_word" readonly>
         </div>
         <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Dung lượng lưu trữ <p>*</p></span>
