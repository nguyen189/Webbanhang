      ...
      <div class="row">
         ...
         <div class="content">
            ...
            <div class="all">
                ...
                <li>
                    <p class="lileft">Phím điều khiển:</p>
                ...
                <li>
                    <p class="lileft">dòng sản phẩm:</p>
...
<section class="view-post">
   ...
   ?> 
   <div class="heading-ct"><h1>đánh giá chi tiết sản phẩm</h1> <a href="all_loa_bluetooth.php" class="inline-option-btn" style="margin-top: 0;">cửa hàng loa bluetooth</a></div>
   <div class="row">
      <div class="col">
