...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="number" placeholder="nhập số điện thoại của bạn" required onkeypress="if(this.value.length == 10) return false;" class="box">
